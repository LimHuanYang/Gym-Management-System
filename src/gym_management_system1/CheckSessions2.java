 ...
 * @author Laptop
 */
public class CheckSessions2 extends javax.swing.JFrame {

    /**
     * Creates new form CheckSessions
     */
    public CheckSessions2() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        if (tbsession.getColumnModel().getColumnCount() > 0) {
            ...
            tbsession.getColumnModel().getColumn(5).setResizable(false);
        }

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 100, 690, -1));
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        try {
            ...
            Logger.getLogger(CheckSessions2.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_formWindowActivated
    public void view_session() throws FileNotFoundException{
        ...
        while(input.hasNext()){
            ...
            String[] data={details[0],details[1],details[2],details[3],details[4],details[5]};
            model.addRow(data);
        }
    }
    /**
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CheckSessions2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
